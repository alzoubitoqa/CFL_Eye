...
## 10) أهم شيء قد يسبب مشاكل بعد النقل

أكثر 5 أشياء تسبب مشاكل عادة:

1. **MySQL password مختلفة** عن الموجودة في `server.js`
2. **قاعدة البيانات أو الجداول غير موجودة**
3. **Node.js غير مثبت**
4. **Driver ESP32 غير مثبت**
5. **IP الجهاز الجديد لم يتم تحديثه في كود ESP32**
